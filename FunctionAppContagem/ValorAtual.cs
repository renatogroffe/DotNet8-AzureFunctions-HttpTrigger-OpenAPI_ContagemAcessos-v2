...
public class ValorAtual
{
    ...
    [Function("DecrementarValorAtual")]
    [OpenApiOperation(operationId: "DecrementarValorAtual", tags: new[] { "ValorAtual" })]
    [OpenApiResponseWithoutBody(statusCode: HttpStatusCode.NoContent, Description = "Operacao de decremento da contagem de acessos")]
    public HttpResponseData RunDecrement([HttpTrigger(AuthorizationLevel.Function, "get")] HttpRequestData req)
    {
        lock (_contador)
        {
        ...
        _logger.LogInformation($"Contador - Decremento realizado com sucesso!");
